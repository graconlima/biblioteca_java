    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/h2-console/**").permitAll() // 1. Libera o endpoint do painel do H2
                .anyRequest().authenticated()
            )
            // 2. Correção para tela em branco: Permite que o H2 renderize os frames na própria página
